...
function tickerSizeAndPosition() {
    ...
    e = "tickerNews";
    document.getElementById(e).style.height = parseInt(document.getElementById("ticker").style.height) + "px", document.getElementById(e).style.width = Math.round(2.05 * parseInt(document.getElementById(e).style.height)) + "px", document.getElementById(e).style.left = "0px", document.getElementById(e).style.top = "0px";
    e = "tickerDiv";
...
function updateTicker() {
    ...
    document.getElementById("tickerNews").style.transform = "translate3d(" + 2 * -e + "px, 0px, 0px)"
}
var permaHideTicker;
...
function showTicker() {
    ...
    document.getElementById("ticker").style.transition = "all .3s ease-out", document.getElementById("ticker").style.MozTransition = "all .3s ease-out", document.getElementById("ticker").style.WebkitTransition = "all .3s ease-out", document.getElementById("ticker").style.transform = "translate3d(0px, 0px, 0px)", document.getElementById("ticker").style.MozTransform = "translate3d(0px, 0px, 0px)", document.getElementById("ticker").style.WebkitTransform = "translate3d(0px, 0px, 0px)";
    document.getElementById("information").style.transition = "all .3s ease-out", document.getElementById("information").style.MozTransition = "all .3s ease-out", document.getElementById("information").style.WebkitTransition = "all .3s ease-out", document.getElementById("information").style.transform = "translate3d(0px, 0px, 0px)", document.getElementById("information").style.MozTransform = "translate3d(0px, 0px, 0px)", document.getElementById("information").style.WebkitTransform = "translate3d(0px, 0px, 0px)"
}
